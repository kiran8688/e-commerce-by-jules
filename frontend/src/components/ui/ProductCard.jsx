    ...
    <div className="group flex flex-col overflow-hidden rounded-[0.75rem] bg-[#ffffff] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(44,47,49,0.06)] hover:-translate-y-1 h-full">
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 p-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100 hidden lg:block bg-gradient-to-t from-black/60 to-transparent">
          <button
            ...
            className="w-full rounded-[0.375rem] bg-[#0050d4] bg-gradient-to-r from-[#0050d4] to-[#7b9cff] px-4 py-3 text-sm font-medium text-[#f1f2ff] shadow-sm hover:from-[#0046bb] hover:to-[#658eff] transition-all flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0050d4] focus-visible:outline-none"
          >
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <button
          ...
          className="mt-4 lg:hidden w-full rounded-[0.375rem] bg-[#eef1f3] px-4 py-2.5 text-sm font-medium text-[#2c2f31] hover:bg-[#dfe3e6] transition-colors flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0050d4] focus-visible:outline-none"
        >
