      ...
      <header className="sticky top-0 z-50 bg-[#f5f7f9]/80 backdrop-blur-xl border-b border-[#eef1f3]">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:py-5">
          ...
          <nav className="hidden md:flex gap-8 text-[0.875rem] font-medium">
            <Link
              to="/"
              className="text-[#595c5e] hover:text-[#0050d4] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0050d4] focus-visible:rounded-sm"
            >
              Home
            </Link>
            <Link
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link
              to="/cart"
              aria-label="Cart"
              className="relative text-[#595c5e] hover:text-[#0050d4] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0050d4] focus-visible:rounded-sm"
            >
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="md:hidden text-[#2c2f31] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0050d4] focus-visible:rounded-sm"
          ...
          <div className="md:hidden absolute top-full left-0 w-full bg-[#ffffff] border-b border-[#eef1f3] shadow-lg">
            <nav className="flex flex-col px-6 py-4 gap-4 text-base font-medium">
              <Link
                ...
                className="text-[#2c2f31] hover:text-[#0050d4] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0050d4] focus-visible:rounded-sm"
              >
                Home
              </Link>
              <Link
              ...
              <Link
                to="/cart"
                onClick={() => setIsMobileMenuOpen(false)}
                className="text-[#2c2f31] hover:text-[#0050d4] flex items-center justify-between focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0050d4] focus-visible:rounded-sm"
              >
                Cart
                <ShoppingCart className="w-5 h-5" />
              </Link>
