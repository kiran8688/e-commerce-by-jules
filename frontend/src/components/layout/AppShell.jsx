        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:py-5">
          ...
          <div className="hidden md:flex items-center gap-6">
            <button
              aria-label="Search"
              title="Search"
              className="text-[#595c5e] hover:text-[#0050d4] transition-colors focus-visible:ring-2 focus-visible:outline-none rounded-sm"
            >
            ...
            <Link
              ...
              aria-label="Cart"
              title="Cart"
              className="relative text-[#595c5e] hover:text-[#0050d4] transition-colors focus-visible:ring-2 focus-visible:outline-none rounded-sm"
            >
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="md:hidden text-[#2c2f31] focus-visible:ring-2 focus-visible:outline-none rounded-sm"
