          ...
          <div className="md:hidden absolute top-full left-0 w-full bg-[#ffffff] border-b border-[#eef1f3] shadow-lg">
            <nav className="flex flex-col px-6 py-4 gap-4 text-base font-medium">
              <Link
                ...
                className="text-[#2c2f31] hover:text-[#0050d4] focus-visible:ring-2 focus-visible:ring-[#0050d4] focus-visible:outline-none rounded-sm"
              >
                Home
              </Link>
              <Link
              ...
              <Link
                to="/cart"
                onClick={() => setIsMobileMenuOpen(false)}
                className="text-[#2c2f31] hover:text-[#0050d4] flex items-center justify-between focus-visible:ring-2 focus-visible:ring-[#0050d4] focus-visible:outline-none rounded-sm"
              >
                Cart
                <ShoppingCart className="w-5 h-5" />
              </Link>
