...
async def test_cors_preflight_restricted():
    ...
    # In newer versions of FastAPI/Starlette, CORSMiddleware returns a 400 Bad Request status code
    # for disallowed CORS preflight (OPTIONS) requests, rather than a 200 OK.
