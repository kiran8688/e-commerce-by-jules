...
async def get_products(db: AsyncSession, skip: int = 0, limit: int = 100) -> list[Product]:
    # Optimization: Use noload() to prevent eager loading of selectin relationships
    # since they are not included in the respective Pydantic response schema to avoid over-fetching
