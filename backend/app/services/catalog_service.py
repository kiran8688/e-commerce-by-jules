...
async def get_products(db: AsyncSession, skip: int = 0, limit: int = 100) -> list[Product]:
    # ⚡ Bolt optimization: Use noload('*') to prevent SQLAlchemy from eagerly loading
    # selectin relationships (images, inventory, reviews) which are omitted in ProductOut.
