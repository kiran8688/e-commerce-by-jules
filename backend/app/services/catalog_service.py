...
async def get_products(db: AsyncSession, skip: int = 0, limit: int = 100) -> list[Product]:
    # Optimize query by preventing eager loading of relationships (N+1/unnecessary joins)
    # Since ProductOut doesn't include relationships like category/images/inventory/reviews,
    # we use raiseload('*') to prevent SQLAlchemy from fetching them automatically via lazy="selectin"
