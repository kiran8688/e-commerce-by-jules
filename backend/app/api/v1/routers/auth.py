...
async def register(payload: UserCreate, db: AsyncSession = Depends(get_db)):
    ...
    """
    # Security Note: Use get_user_by_email instead of authenticate_user to verify existence
    # without performing expensive cryptographic operations that would leak timing information
    # (password oracle vulnerability).
