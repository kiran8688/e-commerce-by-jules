...
from app.services.auth_service import authenticate_user, create_user, issue_token_for_user, get_user_by_email
...
async def register(payload: UserCreate, db: AsyncSession = Depends(get_db)):
    ...
    """
    # Security: Use get_user_by_email to check for existing users instead of authenticate_user
    # authenticate_user performs cryptographic operations (hashing) which can lead to
    # timing attacks, leaking user existence even if they provide a wrong password.
