...
from app.services.auth_service import authenticate_user, create_user, get_user_by_email, issue_token_for_user
...
async def register(payload: UserCreate, db: AsyncSession = Depends(get_db)):
    ...
    """
    # Security: Use get_user_by_email to check for existence, avoiding a password oracle
    # vulnerability that authenticate_user would introduce here.
